...
foreach ($tgl_cetak as $tgl) {
    ...
    $pendapatan[] = query("SELECT * from pengeluaran where tgl_pengeluaran='$tgl_pemasukan' and nama='$sumber'");
}
// var_dump($pendapatan);
...
<body style="width: 50%; padding-top: 15vh; margin-left:50vh; ">
    ...
    <h4 style="text-align: center;">BON PENGELUARAN</h4>
